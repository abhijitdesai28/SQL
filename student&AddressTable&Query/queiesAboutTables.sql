...
-- now add table inside 'school' database
...
-- now see created table
SELECT * FROM address;

-- ADD value into address table
INSERT INTO address (address_id, city ) values (1,'pune');
INSERT INTO address (address_id, city ) VALUE (2,'pune, hadapsar');
INSERT INTO address (address_id, city) VALUE (3,'pune, aundh');
INSERT INTO address (address_id, city) VALUE (4, 'pune, shivajinagar');
...
-- NOW SEE TABLE 'student'
SELECT * FROM student;

-- TO update any colum
UPDATE address
SET city='pune , swargate'
WHERE address_id=1;

-- now see updated table data
SELECT * FROM address;

-- to delete any column from table
DELETE FROM address WHERE address_id=4;

-- now see table deleted or not
SELECT * FROM address;

-- add extra column into 'student' table
ALTER TABLE student
ADD COLUMN percentage FLOAT;

-- NOW SEE COLUMN IS ADDED OR NOT
SELECT * FROM address;

-- delete column from 'address' table
ALTER TABLE address DROP COLUMN percentage;
...
-- NOW ADD 50 DATA IN 'student table'
-- Insert Query
